#changed line 683 - #disable transcription live log
    #log_transcription=False,

#changed line 17 - inport custom output script
    #import send_output
...
#chnged line 543 - commented out lines which write audio file and srt on exit
    ...
    def record(self):
        ...
        try:
            for _ in range(0, int(self.rate / self.chunk * self.record_seconds)):
                ...
                # save frames if more than a minute #MAX EDIT: if more than 1 second (why does it seem to be doubled?)
                if len(self.frames) > 2 * self.rate:
                    if self.save_output_recording:
